...
HASH=2ba6baae1e7c56f652195327d3becd64
...
export CFLAGS
LDFLAGS="-headerpad_max_install_names -arch arm64 -arch x86_64"
LDFLAGS="${LDFLAGS} -Wl,-platform_version,macos,10.15,11.0"
export LDFLAGS
...
#gcc -mmacosx-version-min=10.15 -install_name dist/Python.framework/Python -shared -o dist/Python.framework/Versions/${VERSION}/Python -Wl,-force_load,dist/Python.framework/Versions/${VERSION}/lib/libpython${VERSION}.a
